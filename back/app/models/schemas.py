...
class TripRequest(BaseModel):
    ...
    to_transportation: str = Field(..., description="出发和返回方式", example="飞机")
    transportation: str = Field(default="公交地铁", description="交通方式", example="公共交通")
...
class DayPlan(BaseModel):
    ...
    transportation: str = Field(default="公交地铁", description="交通方式")
...
class TripPlan(BaseModel):
    ...
    to_transportation: Optional[str] = Field(default=None, description="出发和返回方式")
